...
Keep in mind that boundary predictions are calculated from two consecutive times frames $x''_i$, $x''_{i+1}$ and the features $e'_{i,i+1} of the link connecting them. Therefore, boundary predictions fall in-between beat locations. 

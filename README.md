...
Note that this project is focused on the segmentation of popular music genres, section labels predicted follow a 7-class taxonomy containing: "Intro", "Verse", "Chorus", "Bridge", "Instrumental" and "Silence". 
